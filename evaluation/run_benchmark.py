        ...
        if not check_hf_authentication():
            ...
            if not auth_success:
                raise ValueError(
                    ...
                    f"3. Run with token:\n"
                    f"   python evaluation/run_benchmark.py --benchmark {benchmark_name} --hf-token YOUR_TOKEN\n"
...
def get_evaluate_function(aggregator_type: str = 'weighted'):
    ...
    Args:
        aggregator_type: 'base', 'weighted', or 'meta'
    ...
    if aggregator_type == 'base':
        ...
        raise ValueError(f"Unknown aggregator type: {aggregator_type}. Must be 'base', 'weighted', or 'meta'")
...
def evaluate_on_benchmark(
    ...
    Args:
        ...
        aggregator: Aggregator type to use ('base', 'weighted', or 'meta', default: 'weighted')
...
Examples:
  ...
  python evaluation/run_benchmark.py --benchmark HarmBench --limit 100
  
  # Run with base aggregator
  python evaluation/run_benchmark.py --benchmark HarmBench --aggregator base --limit 100
  
  # Run with learned meta aggregator
  python evaluation/run_benchmark.py --benchmark HarmBench --aggregator meta --limit 100
  
  # Run all benchmarks with weighted aggregator
  python evaluation/run_benchmark.py --all --limit 100
  
  # Custom threshold
  python evaluation/run_benchmark.py --benchmark WildGuardMix --threshold 0.8 --aggregator base
        """
    )
